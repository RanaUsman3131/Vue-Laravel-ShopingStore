		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><img src="img/logoold.png" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="nav-item">
								<button class="search"><span class="lnr lnr-magnifier " @click="search" id="search"></span></button>
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="search_input" id="search_input_box">
			<div class="container">
				<form class="d-flex justify-content-between">
					...
					<span class="lnr lnr-cross" id="close_search" @click="close_search" title="Close Search"></span>
				</form>
			</div>
		</div>
	</header>
